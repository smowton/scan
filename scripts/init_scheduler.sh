...
cd ~/scan/jc_probes
javac ScanProbe.java -cp /usr/local/bin/JCatascopiaAgentDir/JCatascopia-Agent-0.0.1-SNAPSHOT.jar:/tmp
cp ScanProbe.class /tmp
cd /tmp
jar cvf ~/scan/jc_probes/ScanProbe.jar ScanProbe.class org
